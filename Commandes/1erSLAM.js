...
module.exports.run = async (bot, message, args) => {
    ...
    let role = message.guild.roles.cache.find(r => r.name == `» Membre`) || message.guild.roles.cache.find(r => r.id == `885444516612538378`)
...
message.member
    ...
    if(aMember.roles.cache.has(role.id)) {
        ...
        .setColor(`#79ff00`)
        .setDescription(`${protect} L'utilisateur ${aMember} vien d'avoir le grade 1er année de SLAM`)
